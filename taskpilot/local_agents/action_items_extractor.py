...
The action items should contain the following information:
    ...
    - labels: The labels of the action item. It can be "Bug", "Feature", "Task", "Story", "Subtask", "Improvement", "Documentation", "Chore", "Refactor", "Test", "Security", "Other". You shall interpret the labels of the action item from the transcript, only if it is very unclear, you shall set it to None.
